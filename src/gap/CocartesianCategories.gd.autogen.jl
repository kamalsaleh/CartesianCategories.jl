...
#! @Returns a morphism ⥉ $\mathrm[Hom](a \sqcup b, a' \sqcup b')$
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( a \sqcup (b \sqcup c), (a \sqcup b) \sqcup c )$.
#! @Arguments a, b, c
...
#! The arguments are three objects $a,b,c$.
#! The output is the associator $\alpha_[(a,b),c]: (a \sqcup b) \sqcup c \rightarrow a \sqcup (b \sqcup c)$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( (a \sqcup b) \sqcup c \rightarrow a \sqcup (b \sqcup c) )$.
#! @Arguments a, b, c
...
#! @Returns a morphism ⥉ $\mathrm[Hom](1 \sqcup a, a)$
#! @Arguments a
@DeclareAttribute( "CocartesianLeftUnitor",
                  IsCapCategoryObject );

#! @Description
#! The arguments are an object $a$ && an object $s == 1 \sqcup a$.
#! The output is the left unitor $\lambda_a: 1 \sqcup a \rightarrow a$.
#! @Returns a morphism ⥉ $\mathrm[Hom](1 \sqcup a, a)$
#! @Arguments a, s
...
#! @Returns a morphism ⥉ $\mathrm[Hom](a, 1 \sqcup a)$
#! @Arguments a
@DeclareAttribute( "CocartesianLeftUnitorInverse",
                  IsCapCategoryObject );

#! @Description
#! The argument is an object $a$ && an object $r == 1 \sqcup a$.
#! The output is the inverse of the left unitor $\lambda_a^[-1]: a \rightarrow 1 \sqcup a$.
#! @Returns a morphism ⥉ $\mathrm[Hom](a, 1 \sqcup a)$
#! @Arguments a, r
...
#! @Returns a morphism ⥉ $\mathrm[Hom](a \sqcup 1, a)$
#! @Arguments a
@DeclareAttribute( "CocartesianRightUnitor",
                  IsCapCategoryObject );

#! @Description
#! The arguments are an object $a$ && an object $s == a \sqcup 1$.
#! The output is the right unitor $\rho_a: a \sqcup 1 \rightarrow a$.
#! @Returns a morphism ⥉ $\mathrm[Hom](a \sqcup 1, a)$
#! @Arguments a, s
...
#! @Returns a morphism ⥉ $\mathrm[Hom](a, a \sqcup 1)$
#! @Arguments a
...
#! @Description
#! The arguments are an object $a$ && an object $r == a \sqcup 1$.
#! The output is the inverse of the right unitor $\rho_a^[-1]: a \rightarrow a \sqcup 1$.
#! @Returns a morphism ⥉ $\mathrm[Hom](a, a \sqcup 1)$
#! @Arguments a, r
