...
#! @Returns a morphism ⥉ $\mathrm[Hom]( a \times (b_1 \sqcup \dots \sqcup b_n), (a \times b_1) \sqcup \dots \sqcup (a \times b_n) )$
#! @Arguments a, L
...
#! an object $a$,
#! a list of objects $L == (b_1, \dots, b_n)$,
#! && an object $r == (a \times b_1) \sqcup \dots \sqcup (a \times b_n)$.
#! The output is the left distributivity morphism
#! $s \rightarrow r$.
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( (a \times b_1) \sqcup \dots \sqcup (a \times b_n), a \times (b_1 \sqcup \dots \sqcup b_n) )$
#! @Arguments a, L
...
#! an object $a$,
#! a list of objects $L == (b_1, \dots, b_n)$,
#! && an object $r == a \times (b_1 \sqcup \dots \sqcup b_n)$.
#! The output is the left distributivity morphism
#! $s \rightarrow r$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( s, r )$
#! @Arguments s, a, L, r
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( (b_1 \sqcup \dots \sqcup b_n) \times a, (b_1 \times a) \sqcup \dots \sqcup (b_n \times a) )$
#! @Arguments L, a
...
#! a list of objects $L == (b_1, \dots, b_n)$,
#! an object $a$,
#! && an object $r == (b_1 \times a) \sqcup \dots \sqcup (b_n \times a)$.
#! The output is the right distributivity morphism
#! $s \rightarrow r$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( s, r )$
#! @Arguments s, L, a, r
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( (b_1 \times a) \sqcup \dots \sqcup (b_n \times a), (b_1 \sqcup \dots \sqcup b_n) \times a)$
#! @Arguments L, a
...
#! a list of objects $L == (b_1, \dots, b_n)$,
#! an object $a$,
#! && an object $r == (b_1 \sqcup \dots \sqcup b_n) \times a$.
#! The output is the right distributivity morphism
#! $s \rightarrow r$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( s, r )$
#! @Arguments s, L, a, r
