...
#! @Returns a morphism ⥉ $\mathrm[Hom]( a \sqcup (b_1 \times \dots \times b_n), (a \sqcup b_1) \times \dots \times (a \sqcup b_n) )$
#! @Arguments a, L
...
#! an object $a$,
#! a list of objects $L == (b_1, \dots, b_n)$,
#! && an object $r == (a \sqcup b_1) \times \dots \times (a \sqcup b_n)$.
#! The output is the left distributivity morphism
#! $s \rightarrow r$.
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( (a \sqcup b_1) \times \dots \times (a \sqcup b_n), a \sqcup (b_1 \times \dots \times b_n) )$
#! @Arguments a, L
...
#! an object $a$,
#! a list of objects $L == (b_1, \dots, b_n)$,
#! && an object $r == a \sqcup (b_1 \times \dots \times b_n)$.
#! The output is the left distributivity morphism
#! $s \rightarrow r$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( s, r )$
#! @Arguments s, a, L, r
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( (b_1 \times \dots \times b_n) \sqcup a, (b_1 \sqcup a) \times \dots \times (b_n \sqcup a) )$
#! @Arguments L, a
...
#! a list of objects $L == (b_1, \dots, b_n)$,
#! an object $a$,
#! && an object $r == (b_1 \sqcup a) \times \dots \times (b_n \sqcup a)$.
#! The output is the right distributivity morphism
#! $s \rightarrow r$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( s, r )$
#! @Arguments s, L, a, r
...
#! @Returns a morphism ⥉ $\mathrm[Hom]( (b_1 \sqcup a) \times \dots \times (b_n \sqcup a), (b_1 \times \dots \times b_n) \sqcup a)$
#! @Arguments L, a
...
#! a list of objects $L == (b_1, \dots, b_n)$,
#! an object $a$,
#! && an object $r == (b_1 \times \dots \times b_n) \sqcup a$.
#! The output is the right distributivity morphism
#! $s \rightarrow r$.
#! @Returns a morphism ⥉ $\mathrm[Hom]( s, r )$
#! @Arguments s, L, a, r
